...
public class TwoFourTree<T> implements TreeSet<T> {
...
//					System.out.println(toString()); //XXX
    ...
    public boolean unionWith(TreeSet<T> TreeSet) {
        ...
        Iterator<T> iter = TreeSet.iterator();
        T obj;
        while (iter.hasNext()) {
            obj = iter.next();
...
//	}
    ...
    //Is this set a subset of TreeSet?
    public boolean subsetOf(TreeSet<T> TreeSet) {
        ...
        while ( obj != null) {
            ...
            if (TreeSet.belongsTo(obj) == false) {
                return false;
            }
            obj = findG(obj) ;
        }*/
